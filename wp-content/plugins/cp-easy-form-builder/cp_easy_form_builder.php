...
function cp_easy_form_check_posted_data() {
    ...
    {
        if (@strtolower($_GET['hdcaptcha']) != $_SESSION['rand_code'.$sequence] || $_SESSION['rand_code'.$sequence] == '')
        {
            echo 'captchafailed';
            exit;
        }
    ...
    if ( (cp_easyform_get_option('cv_enable_captcha', CP_EASYFORM_DEFAULT_cv_enable_captcha) != 'false') && (strtolower($_POST['hdcaptcha']) != $_SESSION['rand_code'.$sequence]))
    {
        echo 'captchafailed';
        exit;
    }
