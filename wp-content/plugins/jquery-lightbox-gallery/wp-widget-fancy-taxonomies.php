<?php If (!Class_Exists('wp_widget_fancy_taxonomies')){
Class wp_widget_fancy_taxonomies Extends WP_Widget {
  ...
  Function __construct(){
    ...
    parent::__construct (
      False,
      $this->t('Fancy Taxonomies'),
      Array('description' => $this->t('Displays your Gallery taxonomies like Gallery Categories, Tags, Events, Photographers, etc.'))
    );    
  }
  ...
  Function Form ($settings){
    ...
    ?>
    <p class="pro-notice"><?php $this->fancy_gallery->Pro_Notice() ?></p>
    <p>
    ...
    <p>
      ...
      <label for="<?php echo $this->get_field_id('count'); ?>"><?php _e( 'Show Gallery counts.' ); ?></label>
    </p>    
